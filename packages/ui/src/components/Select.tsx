...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'focus:outline-none focus:ring-2 focus:ring-[#0052FF]/30 focus:border-[#0052FF]',
      'disabled:cursor-not-allowed disabled:opacity-50',
      'dark:border-slate-800 dark:bg-slate-950 dark:text-slate-50',
      'dark:focus:border-[#336BFF] dark:focus:ring-[#336BFF]/30',
      '[&>span]:line-clamp-1',
      className,
    )}
    {...props}
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'dark:text-slate-50 dark:focus:bg-slate-800 dark:focus:text-slate-50',
      className,
    )}
    {...props}
  >
